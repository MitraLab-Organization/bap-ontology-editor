...
|----|------|--------|------------|
| `BAP_0012002` | **Abdomen** | Trunk | Abdominal region of the trunk |
| `BAP_0000006` | **Appendages** | Body |  |
| `BAP_0020401` | **Arteries** | Vascular system | Arterial blood supply to the head |
| `BAP_0021301` | **Arteries** | Vascular system | Arterial blood supply to the neck |
| `BAP_0012000` | **Body** | (root) | Root structure for the entire body |
| `BAP_0012004` | **Brain** | Central nervous system | Central nervous system organ in the head |
| `BAP_0020006` | **Cavities and passages** | Head | Anatomical spaces and passages of the head |
| `BAP_0021005` | **Cavities and passages** | Neck | Anatomical passages of the neck |
| `BAP_0020202` | **Central nervous system** | Nervous system | Central nervous system structures in the head |
| `BAP_0021203` | **Central nervous system** | Nervous system | Central nervous system structures in the neck |
| `BAP_0021202` | **Cervical nerves** | Peripheral nervous system | Spinal nerves of the cervical region |
...
| `BAP_0020001` | **Musculoskeletal system** | Head | Musculoskeletal structures of the head including muscles and cranium |
| `BAP_0021001` | **Musculoskeletal system** | Neck | Musculoskeletal structures of the neck |
| `BAP_0000010` | **Nasal cavity** | Cavities and passages | Nasal passage |
| `BAP_0020602` | **Nasal sinuses** | Cavities and passages | Paranasal sinus cavities |
| `BAP_0000002` | **Neck** | Body |  |
| `BAP_0021101` | **Neck muscles** | Musculoskeletal system | Muscles of the neck region |
| `BAP_0021102` | **Neck skeletal system** | Musculoskeletal system | Skeletal structures of the neck |
| `BAP_0020002` | **Nervous system** | Head | Neural structures of the head |
| `BAP_0021002` | **Nervous system** | Neck | Neural structures of the neck |
| `BAP_0000138` | **Neurocranium** | Cranium | Bones enclosing the brain |
| `BAP_0020303` | **Olfactory epithelium** | Sense organs | Sensory epithelium for smell |
| `BAP_0020601` | **Oral cavity** | Cavities and passages | Mouth cavity |
| `BAP_0020502` | **Palatal submucosa** | Endocrine and exocrine system | Submucosal glandular tissue of the palate |
| `BAP_0020501` | **Parotid glands** | Endocrine and exocrine system | Major salivary glands near the ear |
...
| `BAP_0021601` | **Skin** | Integumentary system | Skin covering the neck |
| `BAP_0012005` | **Spinal Cord** | Central nervous system | Central nervous system structure extending from brain |
...
| `BAP_0020402` | **Veins** | Vascular system | Venous drainage of the head |
| `BAP_0021302` | **Veins** | Vascular system | Venous drainage of the neck |
| `BAP_0000139` | **Viscerocranium** | Cranium | Facial skeleton bones |
...
| `BAP_0000043` | **Depressor septi nasi** | Cranial muscles |  |
| `BAP_0000014` | **Digastricus anterior** | Cranial muscles | Depress mandible |
...
| `BAP_0000042` | **Nasalis** | Cranial muscles |  |
| `BAP_0000029` | **Occipitalis** | Cranial muscles | Scalp movment |
| `BAP_0000075` | **Omohyoideus** | Neck muscles | Infrahyoid muscle; depresses hyoid bone and stabilizes during speech |
...
| ID | Name | Parent | Definition |
|----|------|--------|------------|
| `BAP_0012025` | **Abducens nerve** | Cranial Nerves | Sixth cranial nerve, motor for lateral rectus muscle |
| `BAP_0001003` | **Accessory nerve** | Cranial Nerves |  |
| `BAP_0001000` | **Facial nerve** | Cranial Nerves |  |
| `BAP_0001001` | **Glossopharyngeal nerve** | Cranial Nerves |  |
| `BAP_0001002` | **Hypoglossal nerve** | Cranial Nerves |  |
| `BAP_0012023` | **Oculomotor nerve** | Cranial Nerves | Third cranial nerve, motor for eye movement |
| `BAP_0012021` | **Olfactory nerve** | Cranial Nerves | First cranial nerve, sensory for smell |
| `BAP_0012022` | **Optic nerve** | Cranial Nerves | Second cranial nerve, sensory for vision |
| `BAP_0012020` | **Terminal nerve** | Cranial Nerves | Cranial nerve zero, associated with pheromone detection |
| `BAP_0001004` | **Trigeminal nerve** | Cranial Nerves |  |
| `BAP_0012024` | **Trochlear nerve** | Cranial Nerves | Fourth cranial nerve, motor for superior oblique muscle |
| `BAP_0012027` | **Vagus nerve** | Cranial Nerves | Tenth cranial nerve, mixed nerve for visceral functions |
| `BAP_0012026` | **Vestibulocochlear nerve** | Cranial Nerves | Eighth cranial nerve, sensory for hearing and balance |

### Skeletal (34 structures)
...
| `BAP_0000124` | **premaxilla** | Viscerocranium |  |
| `BAP_0000136` | **presphenoid** | Neurocranium |  |
| `BAP_0000131` | **scapula** | Forelimb |  |
...
| ID | Name | Parent | Definition |
|----|------|--------|------------|
| `BAP_0002000` | **Lingual artery** | Arteries | Branch of external carotid supplying the tongue |
| `BAP_0002001` | **Maxillary artery** | Arteries | Terminal branch of external carotid, supplies deep face structures |
| `BAP_0002002` | **Temporal artery** | Arteries | Superficial temporal artery supplying temporal region |
