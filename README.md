...
│   │   ├── Sebaceous glands
│   │   ├── Von Ebner's Glands (L)
│   │   └── Von Ebner's Glands (R)
...
│   │   │   │   ├── Nasolabialis (L)
│   │   │   │   ├── Nasolabialis (R)
│   │   │   │   ├── Nasolabialis profundus (L)
│   │   │   │   ├── Nasolabialis profundus (R)
│   │   │   │   ├── Oblique intrinsic muscle (whisker) (L)
│   │   │   │   ├── Oblique intrinsic muscle (whisker) (R)
│   │   │   │   ├── Occipitalis (L)
│   │   │   │   ├── Occipitalis (R)
│   │   │   │   ├── Orbicularis oculi (L)
│   │   │   │   ├── Orbicularis oculi (R)
...
│   │   ├── Head lymphatics (L)
│   │   │   ├── Lymph nodes (L)
│   │   │   └── Nasal-Associated Lymphoid Tissue (L)
│   │   ├── Head lymphatics (R)
│   │   │   ├── Lymph nodes (R)
│   │   │   └── Nasal-Associated Lymphoid Tissue (R)
│   │   ├── Head veins (L)
│   │   └── Head veins (R)
│   ├── Sense organs
│   │   ├── Eye (L)
...
│   │   ├── Neck muscles
│   │   │   ├── Neck muscles (cranial nerve innervated)
│   │   │   │   ├── Cleidomastoideus (L)
│   │   │   │   ├── Cleidomastoideus (R)
│   │   │   │   ├── Cleidooccipitalis (L)
│   │   │   │   ├── Cleidooccipitalis (R)
...
│   │   │   │       ├── Spinotrapezius (L)
│   │   │   │       └── Spinotrapezius (R)
│   │   │   └── Neck muscles (spinal nerve innervated)
│   │   │       ├── Cricothyroideus (L)
│   │   │       ├── Cricothyroideus (R)
│   │   │       ├── Epaxial Neck muscles (dorsal ramus innervated)
│   │   │       │   ├── Semispinalis (L)
│   │   │       │   ├── Semispinalis (R)
│   │   │       │   ├── Splenius (L)
│   │   │       │   │   ├── Splenius capitis (L)
...
│   │   │       │   │   ├── Splenius capitis (R)
│   │   │       │   │   └── Splenius cervicis (R)
│   │   │       │   ├── Transversospinalis muscles (L)
│   │   │       │   └── Transversospinalis muscles (R)
│   │   │       ├── Hypaxial Neck muscles (ventral ramus innervated)
│   │   │       │   ├── Esophagus muscles
│   │   │       │   ├── Longus capitis (L)
│   │   │       │   ├── Longus capitis (R)
│   │   │       │   ├── Longus colli (L)
...
│   │   │       │   ├── Scalenus medius (L)
│   │   │       │   ├── Scalenus medius (R)
│   │   │       │   ├── Scalenus ventralis (L)
│   │   │       │   └── Scalenus ventralis (R)
│   │   │       ├── Omohyoideus (L)
│   │   │       ├── Omohyoideus (R)
│   │   │       ├── Sternohyoideus (L)
│   │   │       ├── Sternohyoideus (R)
